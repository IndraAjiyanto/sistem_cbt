...
<body class="font-poppins text-[#0A090B]">
    <section id="content" class="flex">
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <form action="{{route('dashboard.courses.store')}}" enctype="multipart/form-data" method="post" class="flex flex-col gap-[30px] w-[500px] mx-[70px] mt-10">
                @csrf
                <div class="flex gap-5 items-center">
                    <input type="file" name="cover" id="cover" class="peer hidden" onchange="previewFile()" data-empty="true" required>
                ...
                <div class="flex items-center gap-5">
                    ...
                    <button type="submit" name="submit" class="w-full h-[52px] p-[14px_20px] bg-[#6436F1] rounded-full font-bold text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] text-center">Save Course</button>
                </div>
            </form>
        </div>
    </section>
